...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/dashdiamond-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/dashdiamond-cli.cpp \
           src/dashdiamond-tx.cpp \
           src/dashdiamond.cpp \
           src/db.cpp \
           ...
           src/qt/dashdiamond.cpp \
           src/qt/dashdiamondstrings.cpp \
...
RESOURCES += src/qt/dashdiamond.qrc src/qt/dashdiamond_locale.qrc

TRANSLATIONS += src/qt/locale/dashdiamond_bg.ts \
                src/qt/locale/dashdiamond_de.ts \
                src/qt/locale/dashdiamond_en.ts \
                src/qt/locale/dashdiamond_es.ts \
                src/qt/locale/dashdiamond_fi.ts \
                src/qt/locale/dashdiamond_fr.ts \
                src/qt/locale/dashdiamond_it.ts \
                src/qt/locale/dashdiamond_ja.ts \
                src/qt/locale/dashdiamond_pl.ts \
                src/qt/locale/dashdiamond_pt.ts \
                src/qt/locale/dashdiamond_ru.ts \
                src/qt/locale/dashdiamond_sk.ts \
                src/qt/locale/dashdiamond_sv.ts \
                src/qt/locale/dashdiamond_vi.ts \
                src/qt/locale/dashdiamond_zh_CN.ts \
                src/qt/locale/dashdiamond_zh_TW.ts
