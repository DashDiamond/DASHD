...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04943562aadf58d6b70867178e256d3692f9f9a2746302f1d802a2349efdbdec25e6d7eef91b6efaf732b33ac2995b850e794abf5351ca36ae0330cf431949383e");
        nDefaultPort = 12341;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 150;
        nTargetSpacingSlowLaunch = 1 * 150;
        nTargetSpacing = 1 * 150;
        nMaturity = 15;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04269d7e08ec3f33895e990cc9d0df716a860c1165f0c4108a9d5e0ce04dc93803606b1b30adcaa48d6fce12c676aad91a9117aca59f7f60f56a1369d6fb2e9729") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1567042340;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1911933;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e474f09929213ecad858b8c24002f8146cb459b98e5f665c27eea85f279"));
        assert(genesis.hashMerkleRoot == uint256("0x81c003fa9402b6c2066b34f13788085487aac22a7ba0bf626a67bbb4c69addd4"));

	vSeeds.push_back(CDNSSeedData("217.69.14.34", "217.69.14.34"));
        vSeeds.push_back(CDNSSeedData("217.69.3.166", "217.69.3.166"));
        vSeeds.push_back(CDNSSeedData("217.69.14.214", "217.69.14.214"));
        vSeeds.push_back(CDNSSeedData("95.179.209.27", "95.179.209.27"));
	...
	strSporkKey = "04923AAEF36DE7CBC1C400EE34267F05C36C76D68CCC2A0026359E114D87DB2715FE1D22C101BC12E106787910C75CCCC253838840081E4D1FC0FF1DB6ABA487FA";
        strObfuscationPoolDummyAddress = "D5EPgbVAg9hSZa1Eyt19eYSTpgLUnkJcBy";
        nStartMasternodePayments = 1567042340;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DashDiamond: 1 day
        nTargetSpacing = 1 * 60;  // DashDiamond: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // DashDiamond: 1 day
        nTargetSpacing = 1 * 60;        // DashDiamond: 1 minutes
