/* src/config/dashdiamond-config.h.  Generated from dashdiamond-config.h.in by configure.  */
/* src/config/dashdiamond-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DASHDIAMOND_CONFIG_H

#define DASHDIAMOND_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.dashdiamond.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DashDiamond Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DashDiamond Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dashdiamond"
