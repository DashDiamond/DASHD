...
void BitcoinMiner(CWallet* pwallet, bool fProofOfStake)
{
    ...
    RenameThread("Dashdiamond-miner");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        if (fProofOfStake) {
            ...
            while (chainActive.Tip()->nTime < 1525981707 || vNodes.empty() || pwallet->IsLocked() || !fMintableCoins || (pwallet->GetBalance() > 3 && nReserveBalance >= pwallet->GetBalance()) || !masternodeSync.IsSynced()) {
