                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DashDiamond Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DashDiamond address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dashdiamond: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DashDiamond Core"), this);
    aboutAction->setStatusTip(tr("Show information about DashDiamond Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DashDiamond"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DashDiamond addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DashDiamond addresses"));
    ...
    openAction->setStatusTip(tr("Open a DashDiamond: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DashDiamond Core help message to get a list with possible DashDiamond command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DashDiamond Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DashDiamond network", "", count));
}
...
{
    QString strTitle = tr("DashDiamond Core"); // default title
...
/** Creates context menu, its actions, and dashdiamonds up all the relevant signals for mouse events. */
