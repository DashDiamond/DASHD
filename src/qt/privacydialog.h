...
public:
    ...
    void setZDashDiamondControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDASHD_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDASHD_clicked();
    void on_pushButtonZDashDiamondControl_clicked();
