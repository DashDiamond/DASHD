...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted DashDiamond to zDASHD");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zDASHD");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received DashDiamond from zDASHD");
    case TransactionRecord::ZerocoinSpend_Change_zDASHD:
        return tr("Minted Change as zDASHD from zDASHD Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zDASHD to DashDiamond");
