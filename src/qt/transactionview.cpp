                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DashDiamond from zDASHD"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDASHD"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDASHD));
