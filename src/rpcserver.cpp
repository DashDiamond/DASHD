...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DashDiamond features */
        {"dashdiamond", "masternode", &masternode, true, true, false},
        {"dashdiamond", "listmasternodes", &listmasternodes, true, true, false},
        {"dashdiamond", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dashdiamond", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dashdiamond", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dashdiamond", "masternodedebug", &masternodedebug, true, true, false},
        {"dashdiamond", "startmasternode", &startmasternode, true, true, false},
        {"dashdiamond", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dashdiamond", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dashdiamond", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dashdiamond", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dashdiamond", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dashdiamond", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dashdiamond", "mnbudget", &mnbudget, true, true, false},
        {"dashdiamond", "preparebudget", &preparebudget, true, true, false},
        {"dashdiamond", "submitbudget", &submitbudget, true, true, false},
        {"dashdiamond", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dashdiamond", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dashdiamond", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dashdiamond", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dashdiamond", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dashdiamond", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dashdiamond", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dashdiamond", "checkbudgets", &checkbudgets, true, true, false},
        {"dashdiamond", "mnsync", &mnsync, true, true, false},
        {"dashdiamond", "spork", &spork, true, true, false},
        {"dashdiamond", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dashdiamond", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dashdiamondd, or the -server option to dashdiamond-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
