...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 DASHDIAMOND at the same time
...
enum ZerocoinSpendStatus {
    ZDASHDIAMOND_SPEND_OKAY = 0,                            // No error
    ZDASHDIAMOND_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZDASHDIAMOND_WALLET_LOCKED = 2,                         // Wallet was locked
    ZDASHDIAMOND_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZDASHDIAMOND_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZDASHDIAMOND_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZDASHDIAMOND_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZDASHDIAMOND_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZDASHDIAMOND_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZDASHDIAMOND_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZDASHDIAMOND_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZDASHDIAMOND_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZDASHDIAMOND_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZDASHDIAMOND_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZDASHDIAMOND_SPENT_USED_ZDASHDIAMOND = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZDashDiamondAutoBackups(bool fEnabled)
    {
